                ...
                <div className="stake__tab--inner">
                    ...
                    {tab === "stake" && <div className="stake__stake">
                        <div className="stake__stake--text--inner">
                            ...
                            <p className="text">
                                By staking $vPAYFE tokens, users have the opportunity to earn wstETH rewards.
                            </p>

                            <p className="text">
                                The staked $PAYFE tokens are converted into $vPAYFE tokens, which maintain a 1:1 ratio with $PAYFE. Users can withdraw their $vPAYFE tokens at any time and redeem them for $PAYFE.
                            </p>

                            <div className="stake__stake--text--border">
                                <p className="text">
                                    In addition, the treasury-owned ETH assets (LSD) generate a substantial amount of ETH income for Staked $PAYFE, with 100% of the treasury and protocol income as well as bond sales dividends being allocated to Staked $PAYFE.
                                </p>
                            </div>
                        </div>
                    ...
                    {tab === "unstake" && <div className="stake__stake">
                        <div className="stake__stake--text--inner">
                            ...
                            <p className="text">
                                The staked $PAYFE becomes $vPAYFE, which maintains a 1:1 ratio with $PAYFE.
                            </p>

                            <p className="text">
                                The $vPAYFE can be redeemed back to $PAYFE at any time, but doing so will discontinue the receipt of wstETH rewards.
                            </p>

                            <div className="stake__stake--text--border">
                                <p className="text">
                                    Unstaking $vPAYFE will automatically claim any accumulated rewards.
                                </p>
                            </div>
                        </div>
